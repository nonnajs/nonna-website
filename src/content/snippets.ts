export const REPO = "https://github.com/nonnajs/nonna";

export const snippets = {
  install: `npm install @nonnajs/di`,
...
npm install --save-dev @nonnajs/compiler`,
  ...
  installPnpm: `# pnpm
pnpm add @nonnajs/di
pnpm add -D @nonnajs/compiler`,

  installYarn: `# yarn
yarn add @nonnajs/di
yarn add -D @nonnajs/compiler`,
...
bun add -d @nonnajs/compiler`,
  ...
  aotOutput: `// AUTO-GENERATED by @nonnajs/compiler - do not edit by hand.
...
export const samples = [
  {
    ...
    runtime: "Node.js (18+)",
    icon: "node",
    highlights: "`@nonnajs/compiler` AOT, request scopes, optional deps, `OnDestroy`",
  },
  {
...
export const comparisonBullets = [
  {
    ...
    body: "`@nonnajs/compiler` statically analyzes your TypeScript at build time, using the real TypeScript `TypeChecker`, and generates plain `defineDependencies(Target, [...])` calls. `@nonnajs/di`'s runtime injector never imports `typescript`, never touches `Reflect.getMetadata`, and never needs `emitDecoratorMetadata` turned on.",
  },
  {
  ...
  },
  {
    ...
    body: "`@nonnajs/di`'s `package.json` ships an empty `dependencies` object.",
  },
  {
